...
hl.window_rule({
  name = "zen-beta-file-upload",
  match = { class = "zen-beta", title = ".*File Upload.*" },
  float = true,
  center = true,
  focus_on_activate = true,
  dim_around = true,
...
hl.window_rule({
  name = "zen-beta-bitwarden-extension",
  match = { class = "zen-beta", title = ".*Extensão.*Bitwarden.*" },
  float = true,
  center = true,
  focus_on_activate = true,
  dim_around = true,
